...
class bSkinSaverUI(QtWidgets.QDialog):
    def __init__(self, parent=getMayaWindow()):
        ...
        #select files
        self.selectObjectsFileButton.clicked.connect(self.selectObjectsFile)
        self.selectVerticesFileButton.clicked.connect(self.selectVerticesFile)

        self.saveObjectsButton.clicked.connect(self.saveObjects)
        self.loadObjectsButton.clicked.connect(self.loadObjects)
        self.loadObjectsSelectionButton.clicked.connect(self.loadObjectsSelection)
                            
        self.saveVerticesButton.clicked.connect(self.saveVertices)
        self.loadVerticesButton.clicked.connect(self.loadVertices)
