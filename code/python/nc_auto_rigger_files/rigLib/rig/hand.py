        ...
        if iteration == 0:
            ...
            if finger[0] == prefix_compare[iteration-1]:
                ...
                if joint == finger_joints[-1]:
                    ...
                    if 'thumb' in joint:
                        finger_fk = nc_fk_setup.Setup(lfinger_list, incl_last=False, prefix=prefix, rigScale=rigScale, rigModule=rigModule)
                    else:
                        finger_fk = nc_fk_setup.Setup(lfinger_list, incl_last=False, prefix=prefix, rigScale=rigScale, rigModule=rigModule)
                ...
                finger_fk = nc_fk_setup.Setup(fk_chain, incl_last=False, prefix=prefix, rigScale=rigScale, rigModule=rigModule)
                finger_fk_rt = finger_fk.build()
